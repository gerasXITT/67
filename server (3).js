...
const ADMIN_TOKEN = process.env.ADMIN_TOKEN || "GERAS_ADMIN";

const DATA_DIR  = process.env.DATA_DIR || path.join("/tmp", "gerashub-data");
...
function generateKeys(count, type) {
    ...
    while (created.length < count && tries < count * 500) {
        tries++;
        const key = "GERAS-" + randomSegment(8) + "-" + randomSegment(8);
...
const server = http.createServer((req, res) => {
    ...
    if (route === "/")
        return send(200, { ok: true, service: "gerasHUB KeySystem", version: "4.0" });
...
server.listen(PORT, "0.0.0.0", () => {
    console.log("================================================");
    console.log("  gerasHUB v4  |  KEY SYSTEM SERVER");
    console.log("================================================");
    console.log("  Porta      : " + PORT);
    console.log("  Dados      : " + DATA_DIR);
    console.log("  Admin token: (via env ADMIN_TOKEN ou GERAS_ADMIN)");
    console.log("================================================");
});
